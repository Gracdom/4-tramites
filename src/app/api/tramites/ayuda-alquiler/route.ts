...
export async function POST(request: NextRequest) {
  try {
    ...
    sendConfirmationToClient({
      to: email,
      subject: 'Hemos recibido tu solicitud de Ayuda al Alquiler - Burocracia Cero',
      html: clientConfirmacionTramite(nombreCompleto, 'Ayuda al Alquiler'),
    }).catch((e) => console.error('[ayuda-alquiler] Email cliente:', e))
