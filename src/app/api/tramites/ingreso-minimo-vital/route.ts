...
export async function POST(request: NextRequest) {
  try {
    ...
    crearNotificacion({
      ...
      descripcion: `${nombreCompleto} ha enviado una solicitud para Ingreso Mínimo Vital`,
      metadata: JSON.stringify({ tramiteId: tramite.id, email, tabla: 'tramite_ingreso_minimo_vital' }),
    }).catch((e) => console.error('[ingreso-minimo-vital] Notificación:', e))
