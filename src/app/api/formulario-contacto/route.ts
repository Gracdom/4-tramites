...
// POST - Crear registro del formulario de contacto
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error en POST /api/formulario-contacto:', error)
    return NextResponse.json(
...
// GET - Obtener registros del formulario de contacto
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error en GET /api/formulario-contacto:', error)
    return NextResponse.json(
      { error: 'Error interno del servidor' },
      { status: 500 }
    )
